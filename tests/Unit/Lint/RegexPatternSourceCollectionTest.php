...
final class RegexPatternSourceCollectionTest extends TestCase
{
    ...
    {
        $source = $this->createStub(RegexPatternSourceInterface::class);
    ...
    {
        $source1 = $this->createStub(RegexPatternSourceInterface::class);
        ...
        $source2 = $this->createStub(RegexPatternSourceInterface::class);
